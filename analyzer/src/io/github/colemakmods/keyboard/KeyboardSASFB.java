...
public class KeyboardSASFB {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (options.outputFormat.indexOf('t') >= 0) {
                KeyboardAnalysisTextReport kr = new KeyboardAnalysisTextReport(options.sfbListSize,
                        options.nfbListSize);
    ...
    private static KeyboardLayout run_sa(KeyboardLayout keyboardLayout, List<CharFreq> charFreqs,
        ...
        currentEffort = layoutResults.getTotalSFBEffort();
        ...
        while (t > 1e-3) {
            ...
            neighbourEffort = layoutResults.getTotalSFBEffort();
            ...
            if (currentEffort < bestEffort) {
                System.out.println(
                        "Best layout updated currentEffort " + currentEffort + " bestEffort " + bestEffort
                                + " temperature " + t);
                System.out.println("Temp " + t + " costDelta " + costDelta + " stateDelta " +
    ...
    public LayoutResults performAnalysis(KeyboardLayout keyboardLayout, List<CharFreq> charFreqs,
        ...
        List<FingerBigram> neighbourPenaltyFingerBigrams = findNeighbourFingerBigrams(keyboardLayout, bigramFreqs,
                false);
        List<FingerBigram> neighbourBenefitFingerBigrams = findNeighbourFingerBigrams(keyboardLayout, bigramFreqs,
                true);
